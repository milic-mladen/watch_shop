				...
				<div class="col-lg-12">
					<div class="login_form_inner" style="padding: 20px">
						...
						<table border="3" style="margin: 0 auto">
							...
							%>
							<tr>
								<td><%=categoriesList.get(i).getName()%></td>
								<!-- znaci ne saljemo na edit nego showEditUser pa tamo kada popunimo onda edit-->
								<td style="padding: 5px;"><a
									href="AdminController?action=showEditCategory&categoryId=<%=categoriesList.get(i).getId()%>">Edit</a></td>
								<td style="padding: 5px;"><a
									href="AdminController?action=deleteCategory&categoryId=<%=categoriesList.get(i).getId()%>">Delete</a></td>
							</tr>
