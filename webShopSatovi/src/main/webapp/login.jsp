				...
				<div class="col-lg-6">
					<div class="login_form_inner"">
							...
							<form class="row login_form" action="UserController"
								...
								<div class="col-md-12 form-group">
									<input type="text" class="form-control" name="adress"
										...
										value="<%=(user != null) ? user.getAdress() : ""%>">
								</div>
								<div class="col-md-12 form-group">
								<%
							if (user != null && user.getEmail().equals("") && 
							!user.getAdress().equals("")&&!user.getFirst_name().equals("")&&
							!user.getLast_name().equals("")&& !user.getPassword().equals("")&&
						...
						<%	}%>
								...
								<%
								String msg = (String) request.getAttribute("msgRegister");
								if (msg != null) {
