...
//kupimo category koji nam stize iz kontrolera
Category c = (Category) request.getAttribute("category");
HashMap<String, String> categoryErrors = null;
categoryErrors = (HashMap<String, String>) request.getAttribute("categoryErrors");
if (c != null) {
%>
				...
				<div class="col-lg-12">
							...
							<form class="row login_form" action="AdminController"
								...
								<div class="col-md-12 form-group">
									<input type="text" class="form-control" name="name"
										...
										onblur="this.placeholder = 'Name'" value="<%=c.getName()%>">
								</div>
						</div>
					</div>
					...
					<div class="col-md-12 form-group">
						<button type="submit" name="action" value="editCategory"
							class="button button-login w-100">EDIT CATEGORY</button>
					</div>
