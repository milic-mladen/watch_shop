				...
				<div class="col-lg-12">
					<div class="login_form_inner" style="padding: 20px">
						...
						<table border="3" style="margin: 0 auto">
							...
							%>
							<tr>
								<td><%=productsList.get(i).getName()%></td>
								<td><%=productsList.get(i).getDescription()%></td>
								<td><%=productsList.get(i).getPrice()%></td>
								<td><%=productsList.get(i).getStockNumber()%></td>
								<td><%=productsList.get(i).getColor()%></td>
								<td><%=productsList.get(i).getImage()%></td>
								<td style="padding: 5px;"><a
									href="AdminController?action=showEditProduct&productId=<%=productsList.get(i).getId()%>">Edit</a></td>
								<td style="padding: 5px;"><a
									href="AdminController?action=deleteProduct&productId=<%=productsList.get(i).getId()%>">Delete</a></td>
							</tr>
