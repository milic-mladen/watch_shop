...
HashMap<String, String>productErrors=null;
productErrors=(HashMap<String, String>)request.getAttribute("productErrors");
if (p != null) {
%>
							...
							<form class="row login_form" action="AdminController"
								...
								<div class="col-md-12 form-group">
									<input type="text" class="form-control" name="price"
										...
										onblur="this.placeholder = 'Price'" value="<%=p.getPrice()%>">
								</div>
								<div class="col-md-12 form-group">
									<input type="text" class="form-control" name="stockNumber"
										placeholder="StockNumber" onfocus="this.placeholder = ''"
										onblur="this.placeholder = 'stockNumber'"
										value="<%=p.getStockNumber()%>">
								</div>
							<div class="col-md-12 form-group">
									<input type="text" class="form-control" name="color"
										placeholder="Color" onfocus="this.placeholder = ''"
										onblur="this.placeholder = 'color'"
										value="<%=p.getColor()%>">
								</div>
								<div class="col-md-12 form-group">
								...
								<div class="col-md-12 form-group">
									<input type="text" class="form-control" name="producerId"
										placeholder="producer id" onfocus="this.placeholder = ''"
										onblur="this.placeholder = 'producer_id'"
										value="<%=p.getProducerId()%>">
								</div>
								<input type="hidden" name="productId" value="<%=p.getId()%>">

								<div class="col-md-12 form-group">
									<button type="submit" name="action" value="editProduct"
										class="button button-login w-100">EDIT PRODUCT</button>
								</div>
